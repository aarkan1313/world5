...
|---|---|---|---|
| 21 | Terrain renderer geometry + draws | 2.0 ms ⚠️ | Largest visible surface; nanite/clipmap-class cost. **Phase 4.5+4.6 calibration WARNING**: measured 4-6 ms on RTX 5090 Laptop at 4-6 rings (stationary OR motion — Phase 4.6 baseline showed cost is rasterization-bound, NOT streaming-bound). Extrapolated 13-25 ms on RTX 3060 (blows budget 7-12×). quality_tiers.json terrain_rings dropped to 3/4/5/6/7 per tier (F2 engaged). True 3060 measurement pending hardware. |
